...
public class CoreNotify {
	...
	//Servicio de consulta de notificaci�n
	public final static String NOTF_GETK_IDEN_RQRD         = "NOTF-03001";
	
	//Servicio de edici�n de notificaci�n
	...
	//Servicio de creaci�n de nuevo dominio
	...
	//Servicio de edici�n de dominio
